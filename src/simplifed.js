...
import { keyboardStatus } from './keyboard-status';

export const SimplifiedJapanese = ( props ) => {
	...
	if (
		...
		const data = {
			...
			_type: 'insert_editor',
			shift_key: keyboardStatus.isPressShiftKey,
			option_key: keyboardStatus.isPressOptKey,
		};
